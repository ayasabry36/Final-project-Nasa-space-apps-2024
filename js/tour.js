var GALAXY_TOUR = [
  {"rx":0.18605511827781787,"ry":2.464222597755626,"z":1.1,"travelTime":2000,"restTime":500,"message":"This is our Sun, the center of the Orrery."},
  {"rx":1.4395420537811414,"ry":6.281532559509658,"z":3.548607771018531,"travelTime":3000,"restTime":500,"message":"Traveling with your car, <br>it would take 66 years to reach the sun moving from Mercury","callback":displaySunEarthDiagram},
  {"rx":0.8369933670834534,"ry":1.837770087331788,"z":4.937978822676058,"travelTime":3000,"restTime":500,"message":"Moving from Venus using a commercial airplan, <br>(19 years) this is what it would take you to get to the sun"}, 
  {"rx":0.6424544063335803,"ry":-0.0031800804774647718,"z":5.23179619362583,"travelTime":3000,"restTime":500,"message":"Now with Earth and Mars, <br>225 million kilometers far from each other, and both are not even 15 light minutes far from the Sun."},  
  {"rx":0.0019755752638865747,"ry":0.23341774437325485,"z":8.290495394205,"travelTime":3000,"restTime":500,"message":"We are going so far, <br>distance from sun to Jupiter is more than 3 times greater than the distance from sun to Mars"},
  {"rx":0.5522785678088462,"ry":1.324151395815386,"z":15.4214873346518,"travelTime":3000,"restTime":500,"message":"You're now seeing the whole Orrery, <br>8 Palnets and lots of object bodys moving around the sun"},
  {"rx":0.503337952515914,"ry":-0.9904961225532652,"z":432.34847195438465,"travelTime":3000,"restTime":500,"message":"These are the near-earth object bodies closest to our Orrery <br>The nearest star system, Alpha Centauri, is 4.3 light years away."},
  {"rx":-0.12216429754294249,"ry":1.9989722678912,"z":79999.99999999994,"travelTime":3000,"restTime":500,"message":"All of which are in the Milky Way... which has 200 to 400 billion stars in total.", "callback":highlightMilkyWay}, 
];
